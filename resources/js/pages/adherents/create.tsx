            ...
            <div className="p-6 h-full">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Create New Adherent</h1>
                            <p className="text-gray-600 dark:text-gray-300">Fill in the details below to add a new member</p>
                        </div>
                    </div>
                </div>
