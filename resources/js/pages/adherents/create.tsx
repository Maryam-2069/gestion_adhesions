...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create Adherent',
        href: '/create-adherent',
    },
];
            ...
            <div className="p-6 h-full ">
                ...
                <div className="mb-8 ">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-900">Create New Adherent</h1>
                            <p className="text-gray-600">Fill in the details below to add a new member</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className={`w-full pl-10 pr-3 py-3 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 ${
                                                errors.prenom ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className={`w-full pl-10 pr-3 py-3 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 ${
                                                errors.cin ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className={`w-full pl-10 pr-3 py-3 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 ${
                                                errors.telephone ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300'
                                            }`}
