            ...
            <div className="p-6 h-full">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-900">Créer un Type d'Adhésion</h1>
                            <p className="text-gray-600">Définissez les détails du nouveau type d'adhésion</p>
                        </div>
                    </div>
                </div>
