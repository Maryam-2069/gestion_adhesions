            ...
            <div className="p-6 h-full">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Modifier Type d'Adhésion</h1>
                            <p className="text-gray-600 dark:text-gray-300">
                                Modifiez le type "{typeAdhesion.nom}" - {formatDuration(Number(typeAdhesion.duree))} - {formatCurrency(Number(typeAdhesion.prix))}
                            </p>
                        </div>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    {data.duree && (
                                        <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                                            Durée: {formatDuration(Number(data.duree))}
                                        </p>
                                    )}
                                ...
                                <div>
                                    ...
                                    {data.prix && (
                                        <p className="text-xs text-green-600 dark:text-green-400 mt-1">
                                            Prix: {formatCurrency(Number(data.prix))}
                                        </p>
                                    )}
